...
def main():
    ...
    trace1 = go.Bar(
        x=['simple 2', 'simple 3', 'complex 2'],
        y=[average_fetches(simple_2), average_fetches(simple_3), average_fetches(
            complex_2)],
        name='Fetches',
        marker=dict(
            color='rgb(55, 83, 109)'
    ...
    trace2 = go.Bar(
        x=['simple 2', 'simple 3', 'complex 2'],
        y=[average_fetches(simple_2_baseline), average_fetches(simple_3_baseline), average_fetches(
            complex_2_baseline)],
        name='Fetches Baseline',
        marker=dict(
    ...
    py.plot(fig, filename='or_fetches')

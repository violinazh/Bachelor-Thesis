...
def main():
    ...
    trace1 = go.Bar(
        x=['0', '1', '2', '3'],
        y=[average_size(ordered_0), average_size(ordered_1), average_size(
            ordered_2), average_size(ordered_3)],
        name='Heap size',
        marker=dict(
            color='rgb(55, 83, 109)'
        )
    ...
    trace2 = go.Bar(
        x=['0', '1', '2', '3'],
        y=[average_size(baseline_0), average_size(baseline_1), average_size(
            baseline_2), average_size(baseline_3)],
    ...
    py.plot(fig, filename='order_ordered_size')
